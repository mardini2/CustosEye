...
class TestNetworkSnapshot:
    ...
    def test_network_snapshot_extracts_listening_ports(self, mock_net_conn, network_snapshot, mock_publish):
        ...
        # Call run once (normally runs in loop)
    ...
    @patch("agent.network_scan.psutil.net_connections")
    def test_network_snapshot_extracts_remote_endpoints(self, mock_net_conn, network_snapshot, mock_publish):
    ...
    @patch("agent.network_scan.psutil.net_connections")
    def test_network_snapshot_sorts_listening_ports(self, mock_net_conn, network_snapshot, mock_publish):
    ...
    @patch("agent.network_scan.psutil.net_connections")
    def test_network_snapshot_deduplicates_listening_ports(self, mock_net_conn, network_snapshot, mock_publish):
    ...
    @patch("agent.network_scan.psutil.net_connections")
    def test_network_snapshot_handles_no_connections(self, mock_net_conn, network_snapshot, mock_publish):
    ...
    @patch("agent.network_scan.psutil.net_connections")
    def test_network_snapshot_handles_connection_errors(self, mock_net_conn, network_snapshot, mock_publish):
        ...
        try:
            ...
            pytest.fail("NetworkSnapshot should handle AccessDenied gracefully")

    @patch("agent.network_scan.psutil.net_connections")
    @patch("agent.network_scan.time.sleep")
    def test_network_snapshot_runs_in_loop(self, mock_sleep, mock_net_conn, network_snapshot, mock_publish):
    ...
    @patch("agent.network_scan.psutil.net_connections")
    def test_network_snapshot_filters_inet_only(self, mock_net_conn, network_snapshot, mock_publish):
    ...
    @patch("agent.network_scan.psutil.net_connections")
    def test_network_snapshot_handles_missing_raddr(self, mock_net_conn, network_snapshot, mock_publish):
